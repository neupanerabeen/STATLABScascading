...
#hadoop jar /home/hdmasteruser/Downloads/pattern-wip-1.0/pattern-examples/build/libs/pattern-examples-1.0.0-wip-dev.jar data/Input.tsv out/classify --pmml /home/hdmasteruser/Desktop/StatLabs_Scoring_Engine/cache/algorithms/pmml_with_numbers.xml
